      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 pb-8">
        ...
        >
          {[
            {
              icon: Cpu,
              title: 'Hybrid WASM & WebGPU',
              desc: 'Auto-compiles WGSL matrix shaders, falling back dynamically to multi-threaded WASM SIMD for universal compute.',
            ...
            {
              icon: Zap,
              title: 'Direct P2P Pipeline',
              desc: 'Activations travel browser-to-browser over WebRTC data channels. Zero cloud relay. Sub-50ms inter-node latency.',
            ...
            },
            {
              ...
              desc: 'MSE ε < 10⁻⁵ drift checks. Duplicate workloads across peers, auto-schedule tie-breakers, blacklist anomalous nodes.',
